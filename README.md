...
- Git clone:
    - `git clone git@github.com:antpb/magick-widget.git`
...
- WP CLI
    ...
    - Setup site with WP CLI
        - `docker-compose run wpcli wp core install --url=http://localhost:6040 --title="Magick Widget" --admin_user=admin0 --admin_email=something@example.com`
